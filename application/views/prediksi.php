...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Form Prediksi Smartphone</h2>
            ...
            <div class="x_content">
                <form id="formsearch" data-parsley-validate action="#" method="POST" class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">PIlih Smartphone <span class="required">*</span>
                      </label>
...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      $("#formsearch").submit(function(event) {
        event.preventDefault();
        var link = 'prediksi/createprediksi.aspx';
        if (tipe == 0) {return false;}
        // if (tipe == 1) {
        //   link = 'prediksi/createprediksi.aspx';
        // }else{
        //   link = 'prediksi/search_gsmarena.aspx';
        // }
        ...
        .done(function(resp) {
          if (resp) {
            ...
            if (resp.produk.length > 0) {
              ...
              $(".tableproses").html("<center><h3>Tidak Ada Similiarity Smartphone untuk smartphone ini</h3></center>");
            }
          }
          console.log("success");
        })
      ...
      function searchdata(rsp,i) {
        var link;
        var data = 'tgl='+rsp.tgl+'&count='+rsp.jmlkomen+'&q='+rsp.produk[i]+'&idprediksi='+rsp.idprediksi;
        if (rsp.tipe == 1) {
