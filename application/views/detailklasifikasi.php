...
<?php if ($datasearch): ?>
    <?php if ($datasearch->data_search_naive_bayes): ?>
        <div class="row">

            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tabel Detail Nai've Bayes</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><!-- <i class="fa fa-wrench"></i> --></a>
                            </li>
                    ...
                    <div class="x_content">
                        <table id="tabeldetailsummarybayes" class="table table-striped responsive-utilities jambo_table">
                            <thead>
                                <tr class="headings">
                                    <th>No</th>
                                    <th>Komentar </th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table = $('#tabeldetailsummary').DataTable({
              ...
              serverSide: true,
              ajax: {
                url: "<?php echo base_url(); ?>datalist/list_tweet.aspx",
                type: "POST",
                data: function (d) {
                    d.idsearch = <?php echo $idsearch; ?>;
                    return d;
                }
              },
              paginate: true
        ...
        <?php if($datasearch): ?>
            <?php if($datasearch->data_search_naive_bayes): ?>
                var table = $('#tabeldetailsummarybayes').DataTable({
                      // "order": [[ 4, "asc" ]],
                      "columns": [
                        {"orderable":false },
                        {"orderable":false },
                      ...
                      serverSide: true,
                      ajax: {
                        url: "<?php echo base_url(); ?>datalist/list_tweet_bayes.aspx",
                        type: "POST",
                        data: function (d) {
                            d.idsearch = <?php echo $idsearch; ?>;
                            return d;
